...
public class TreePathGenerator {
	...
	public static String getNodePath(JdbcTemplate jdbcTemplate, String bh, String outputField,
                                     String delimiter, com.bh.genbh.common.bh.NamingConfig namingConfig) {
		if (delimiter == null) {
			delimiter = "/";
		}
	...
	public static String getPath(JdbcTemplate jdbcTemplate, String id, com.bh.genbh.common.bh.NamingConfig config) {
		List<String> l = jdbcTemplate.queryForList(getSql("SELECT $bh FROM $tableName WHERE $id =?", config),
				new Object[] { id }, String.class);
		return l.isEmpty() ? null : l.get(0);
	}

	public static List<String> getPathValue(JdbcTemplate jdbcTemplate, String id, com.bh.genbh.common.bh.NamingConfig config,
                                            String field) {
		String path = getPath(jdbcTemplate, id, config);
		return getPathValueByBH(jdbcTemplate, path, config, field);
	}

	public static List<String> getPathValueByBH(JdbcTemplate jdbcTemplate, String bh, com.bh.genbh.common.bh.NamingConfig config,
                                                String field) {
		String path = bh;
	...
	public static List<Map<String, Object>> getPathValue(JdbcTemplate jdbcTemplate, String id,
														 com.bh.genbh.common.bh.NamingConfig config, String[] fields) {
		String path = getPath(jdbcTemplate, id, config);
	...
	public static void buildPath(JdbcTemplate jdbcTemplate, String parentId, com.bh.genbh.common.bh.NamingConfig config) {
	...
	private static void loadTypes(JdbcTemplate jdbcTemplate, String nodeId, List<Map<String, Object>> list,
                                  com.bh.genbh.common.bh.NamingConfig config) {
	...
	private static String getSql(String raw, com.bh.genbh.common.bh.NamingConfig config) {
		return com.bh.genbh.common.bh.NamingConfig.getNamingString(raw, config);
	}
